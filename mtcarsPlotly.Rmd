...
This is a 5 web page presentation using R Markdown that features a plot on mtcars data created with Plotly. It contains an interactive tables where you can move the columns around and an interactive plot of mtcars data with fitted loess line (mpg~disp).
