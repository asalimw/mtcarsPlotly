...
This is a 5 web page presentation using R Markdown that features a plot created with Plotly on mtcars data. It contains interactive tables where you can move the columns around and an interactive plot of mtcars data with fitted loess line (mpg~disp).
